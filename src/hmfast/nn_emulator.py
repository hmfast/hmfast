"""
Neural network emulator classes for cosmological calculations.

This module provides JAX-based neural network emulators that are compatible with
the EDE-v2 cosmology emulators, completely removing the dependency on classy_szfast.
"""
...
# Suppress tensorflow warnings if it gets imported elsewhere
import warnings
...
class RestoreNN:
    """
    JAX-based neural network restoration class for standard emulators.
    Equivalent to classy_szfast.restore_nn.Restore_NN but pure JAX.
    """
...
class RestorePCAplusNN:
    """
    JAX-based neural network with PCA compression.
    Equivalent to classy_szfast.restore_nn.Restore_PCAplusNN but pure JAX.
    """
